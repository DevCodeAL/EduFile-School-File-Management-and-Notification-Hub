...
import { createUpdateNews } from "../../Services/ItemServices";

export default function NewsUpdate({isOpenNews, isCloseNews, newItem, onUpdate}) {
...
// Modal Options
  ...
  const HandleSubmitUpdate = async (e) => {
    ...
    try {
      const response = await createUpdateNews(newItem._id, data);
      onUpdate(response);
      isCloseNews();
    } catch (error) {
