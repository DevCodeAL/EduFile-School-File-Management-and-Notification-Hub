...
export default function DeleteModal({isdeleteOpen, setisDeleteOpen}) {
  ...
  return (
    <>
      <Modal show={isdeleteOpen} size="md" onClose={setisDeleteOpen} popup>
        <Modal.Header />
        ...
        <div className="p-6 rounded-lg shadow-lg w-full max-w-md bg-white relative">
            ...
            <div className="flex justify-center gap-4">
              <Button className="bg-red-600" onClick={() => setisDeleteOpen(false)}>
                {"Yes, I'm sure"}
              </Button>
              <Button color="gray" onClick={() => setisDeleteOpen(false)}>
                No, cancel
              </Button>
            </div>
          </div>
